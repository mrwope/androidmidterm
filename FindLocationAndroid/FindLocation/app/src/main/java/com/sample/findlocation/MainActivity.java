...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                // Tıklanan mekanın koordinatlarıyla Google Maps de göster
    ...
    private static ArrayList<FoursquareVenue> parseFoursquare(final String response) {
        ...
        try {
            ...
            // Gelen url den sonuçları sıralamak için bir jsonObject oluştur
                            ...
                            if (jsonArray.getJSONObject(i).has("location")) {
                                if (jsonArray.getJSONObject(i).getJSONObject("location").has("address")) {
                                    if (jsonArray.getJSONObject(i).getJSONObject("location").has("city")) {
                                        //foursqrVenue nesnesiyle şehir bilgisini elde et
                                    ...
                                    if (jsonArray.getJSONObject(i).getJSONObject("location").has("lat")) {
                                        //foursqrVenue nesnesiyle enlem bilgisini elde et
